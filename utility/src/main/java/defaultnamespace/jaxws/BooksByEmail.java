...
@XmlRootElement(name = "booksByEmail", namespace = "http://utility.hotel.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "booksByEmail", namespace = "http://utility.hotel.com/", propOrder = {"arg0", "arg1"})

public class BooksByEmail {
